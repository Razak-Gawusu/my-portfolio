      ...
      <div className="container">
        <div className="aboutMe__item">
          ...
          <p className="paragraph">
            I'm a software developer who is passionate about developing web apps
            that increase an organization's effectiveness and efficiency.
          </p>
          <p className="paragraph">
            As a software engineer have a good understanding of web technologies
            and can write code to produce dependable and user-friendly
            applications.{" "}
          </p>
          <p className="paragraph">
            I am a skilled communicator, strategic thinker, and imaginative
            developer who creates software that is tailored to match the
            organizational demands of a firm, showcasing its key capabilities,
            and advancing its success.
          </p>
        </div>
